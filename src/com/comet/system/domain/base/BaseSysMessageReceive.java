...
/**
 * This is an object that contains data related to the sys_message_receive table.
 ...
 *
 * @hibernate.class
 *  table="sys_message_receive"
 */

public abstract class BaseSysMessageReceive  implements Serializable{

	public static String REF = "SysMessageReceive";
	 ...
	 */
	public BaseSysMessageReceive (Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.comet.system.domain.SysMessageReceive)) return false;
		else {
			com.comet.system.domain.SysMessageReceive sysMessageReceive = (com.comet.system.domain.SysMessageReceive) obj;
			if (null == this.getId() || null == sysMessageReceive.getId()) return false;
			else return (this.getId().equals(sysMessageReceive.getId()));
		}
	}
