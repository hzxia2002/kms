...
/**
 * This is an object that contains data related to the sys_sms_send table.
...
public abstract class BaseSysSmsSend  implements Serializable{

	public static String REF = "SysSmsSend";
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.comet.system.domain.SysSmsSend)) return false;
		else {
			com.comet.system.domain.SysSmsSend sysSmsSend = (com.comet.system.domain.SysSmsSend) obj;
			if (null == this.getId() || null == sysSmsSend.getId()) return false;
			else return (this.getId().equals(sysSmsSend.getId()));
		}
	}
