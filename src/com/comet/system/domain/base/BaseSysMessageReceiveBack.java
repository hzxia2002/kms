...
/**
 * This is an object that contains data related to the sys_message_receive_back table.
 ...
 *
 * @hibernate.class
 *  table="sys_message_receive_back"
 */

public abstract class BaseSysMessageReceiveBack  implements Serializable{

	public static String REF = "SysMessageReceiveBack";
	public static String PROP_FD_MESSAGE_RECEIVE_TIME = "fdMessageReceiveTime";
	...
	// constructors
	public BaseSysMessageReceiveBack () {
		initialize();
	}
	 ...
	 */
	public BaseSysMessageReceiveBack (Long id) {
		this.setId(id);
		initialize();
	}
	...
	private java.sql.Timestamp fdMessageReceiveTime;
	...
	/**
	 * Return the value associated with the column: FD_MESSAGE_RECEIVE_TIME
	 */
	public java.sql.Timestamp getFdMessageReceiveTime () {
		return fdMessageReceiveTime;
	}

	/**
	 * Set the value related to the column: FD_MESSAGE_RECEIVE_TIME
	 * @param fdMessageReceiveTime the FD_MESSAGE_RECEIVE_TIME value
	 */
	public void setFdMessageReceiveTime (java.sql.Timestamp fdMessageReceiveTime) {
		this.fdMessageReceiveTime = fdMessageReceiveTime;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.comet.system.domain.SysMessageReceiveBack)) return false;
		else {
			com.comet.system.domain.SysMessageReceiveBack sysMessageReceiveBack = (com.comet.system.domain.SysMessageReceiveBack) obj;
			if (null == this.getId() || null == sysMessageReceiveBack.getId()) return false;
			else return (this.getId().equals(sysMessageReceiveBack.getId()));
		}
	}
	...
	public String toString () {
		...
		builder.append(fdMessageReceiveTime);
