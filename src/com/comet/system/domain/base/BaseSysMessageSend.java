...
/**
 * This is an object that contains data related to the sys_message_send table.
 ...
 *
 * @hibernate.class
 *  table="sys_message_send"
 */

public abstract class BaseSysMessageSend  implements Serializable{

	public static String REF = "SysMessageSend";
	 ...
	 */
	public BaseSysMessageSend (Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.comet.system.domain.SysMessageSend)) return false;
		else {
			com.comet.system.domain.SysMessageSend sysMessageSend = (com.comet.system.domain.SysMessageSend) obj;
			if (null == this.getId() || null == sysMessageSend.getId()) return false;
			else return (this.getId().equals(sysMessageSend.getId()));
		}
	}
