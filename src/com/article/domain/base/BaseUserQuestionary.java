...
/**
 * This is an object that contains data related to the user_questionary table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 用户调查表
 * SyncTemplatepatterns : list\w*
 * SyncDao : false
 * TableName : user_questionary
 * SyncBoolean : get
 * SyncJsp : true
 * Treeable : false
 * Projectable : false
...
public abstract class BaseUserQuestionary  implements Serializable{

	public static String REF = "UserQuestionary";
	 ...
	 */
	public BaseUserQuestionary (Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.article.domain.UserQuestionary)) return false;
		else {
			com.article.domain.UserQuestionary userQuestionary = (com.article.domain.UserQuestionary) obj;
			if (null == this.getId() || null == userQuestionary.getId()) return false;
			else return (this.getId().equals(userQuestionary.getId()));
		}
	}
