...
<body>
<form:form id="questionaryEditForm" modelAttribute="bean" name="questionaryEditForm" action="${ctx}/questionary/save.do" method="post">
...
<script type="text/javascript">
    $(function(){
        ...
        v = $('#questionaryEditForm').validate();
    });
</script>