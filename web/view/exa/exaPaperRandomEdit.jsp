...
<body>
<form:form id="exaPaperRandomEditForm" modelAttribute="bean" name="exaPaperRandomEditForm" action="${ctx}/exaPaperRandom/save.do" method="post">
   <input type="hidden" name="id" value="${bean.id}" />
    <table border="0" cellspacing="1" width="100%" class="inputTable">
		         ...
		         <tr class="inputTr">
                    ...
                    <td  class="container">
                        <input type="text" name="paperOrderDetail" value="${bean.paperOrderDetail}" />&nbsp;
                    </td>
...
<script type="text/javascript">
    $(function(){
        ...
        v = $('#exaPaperRandomEditForm').validate();
    });
</script>