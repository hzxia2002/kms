...
<div id="mainLayout" style="width:100%;overflow-y: hidden;overflow-x: hidden;margin:0; padding:0;">
    ...
    <div position="center">
        ...
        <div id="sysUserGrid"  rownumbers="true"  height="100%"  url='${ctx}/sysUser/grid.do' root="rows" record="records"  width="100%"  colDraggable="true" >
        </div>
    </div>
</div>
</body>
...
//        enabledEdit: true
    ...
    function f_select(){
        return $.jui.get("sysUserGrid").getSelectedRow();
    }
</script>