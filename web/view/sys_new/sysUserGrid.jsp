...
//        enabledEdit: true
    ...
    function doAdd(id){
        commonAddOrUpdate("${ctx}/sysUser/initAdd.do?deptId="+id,"sysUserGrid",null,"sysUserEditForm",{title:"新增用户信息",height:600,width:600});
    }
    ...
    function doEdit(){
        ...
        if(url){
            commonAddOrUpdate(url,"sysUserGrid",null,"sysUserEditForm",{title:"新增用户信息",height:600,width:600});
        }
    }
