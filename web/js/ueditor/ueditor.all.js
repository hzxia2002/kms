...
///commandsDialog  dialogs\music
    UE.commands['title'] = {
        execCommand : function(cmdName, obj){
            var me = this;
            var h1Elements = $(me.body).find("h1").not("#contentTitle h1");

            var titleArr = [];
            titleArr.push("<ul>");
            for(var i=0;i<h1Elements.length;i++){
                var id = "title_"+i;
               titleArr.push("<li><a href='#"+id+"'>"+h1Elements[i].outerHTML+"</a></li>");
                $(h1Elements[i]).attr("id",id) ;
            }
            titleArr.push("</ul>");
        ...
        SplitButton.prototype = {
            ...
            getHtmlTpl: function (){
                return '<div id="##" class="edui-box %%">' +
                    ...
                    '<div id="##_button_body" class="edui-box edui-button-body" onclick="alert(12);$$._onButtonClick(event, this);">' +
...
//自己写的ui也要在这里配置，放到baidu.editor.ui下边，当编辑器实例化的时候会根据ueditor.config中的toolbars找到相应的进行实例化
    (function () {
        ...
        var btnCmds = ['undo', 'redo', 'formatmatch',
            ...
            'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable','title'];
